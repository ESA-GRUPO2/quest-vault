...
namespace questvault.Controllers
{
  public class LibraryController(ApplicationDbContext context, SignInManager<User> signInManager) : Controller
  {
    ...
    {
      if (User == null) return RedirectToPage("/Account/Login", new { ReturnUrl = "/Library/UserLibrary" });
      if (User.Identity == null) return RedirectToPage("/Account/Login", new { ReturnUrl = "/Library/UserLibrary" });
