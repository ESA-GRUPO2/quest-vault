...
namespace questvault.Services
{
  ...
  {
    /// <summary>
    /// Searches for games based on names comming from steam on a list of game names.
    /// </summary>
    /// <param name="gameNames">The list of game names to search for.</param>
    /// <returns>A task representing the asynchronous operation that returns an enumerable collection of Game objects.</returns>
    Task<IEnumerable<Game>> SearchGamesSteam(List<string> gameNames);
