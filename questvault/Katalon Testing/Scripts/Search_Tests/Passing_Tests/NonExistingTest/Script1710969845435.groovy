...
WebUI.setText(findTestObject('Object Repository/Page_Home - QuestVault/input_Games_searchTerm'), 'portal')

WebUI.sendKeys(findTestObject('Object Repository/Page_Home - QuestVault/input_Games_searchTerm'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_Results - QuestVault/a_Games_game-button'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Game - QuestVault/h2_Portal'), 'Portal')
