...
WebUI.click(findTestObject('Object Repository/Page_Home - QuestVault/input_Games_searchTerm'))

WebUI.click(findTestObject('Object Repository/Page_Home - QuestVault/img_Games_search-btn'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Results - QuestVault/img'), 0)
