...
WebUI.click(findTestObject('Object Repository/Page_Game - QuestVault/img_Rating 55_icon-trash'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Game - QuestVault/h5_There are no reviews yet'), 'There are no reviews yet.')
