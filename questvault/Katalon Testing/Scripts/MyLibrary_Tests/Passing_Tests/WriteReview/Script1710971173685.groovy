...
WebUI.setText(findTestObject('Object Repository/Page_Game - QuestVault/textarea__reviewV'), 'Really good game')

WebUI.click(findTestObject('Object Repository/Page_Game - QuestVault/span_'))
