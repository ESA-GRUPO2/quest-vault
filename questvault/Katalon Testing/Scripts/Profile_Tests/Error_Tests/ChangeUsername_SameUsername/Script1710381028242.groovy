...
WebUI.setText(findTestObject('Object Repository/Page_My Account - QuestVault/input_Username_Input.NewUserName'), 'Tiago')

WebUI.click(findTestObject('Object Repository/Page_My Account - QuestVault/button_Save Changes'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_My Account - QuestVault/li_Cant change to same username'), 
    'Can\'t change to same username')
